namespace UsbInputMapper.UI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lvwBindings.Location = new System.Drawing.Point(239, 70);
            this.lvwBindings.Size = new System.Drawing.Size(420, 220);
            this.lvwBindings.Columns.Add("アイテム名", 100);
            this.lvwBindings.Columns.Add("入力するボタン", 120);
            this.lvwBindings.Columns.Add("動作", 80);
            this.lvwBindings.Columns.Add("出力される内容", 180);
            this.lvwBindings.DoubleClick += new System.EventHandler(this.btnEditBinding_Click);
            ...
            this.lvwDiagnostic.Location = new System.Drawing.Point(6, 35);
            this.lvwDiagnostic.Size = new System.Drawing.Size(660, 345);
            this.lvwDiagnostic.Columns.Add("時刻", 80);
            this.lvwDiagnostic.Columns.Add("ユーザーが押した内容 (物理入力)", 270);
            this.lvwDiagnostic.Columns.Add("Windowsが受け取った内容", 270);
